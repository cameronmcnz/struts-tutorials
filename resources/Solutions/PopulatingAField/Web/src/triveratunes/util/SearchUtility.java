...
public class SearchUtility
{
   ...
   public static Collection<CD> search(String keyword)
   {
      ...
      Iterator<CD> i = c_catalog.iterator();
      while (i.hasNext())
      {
         CD item = (CD) i.next();
      ...
      System.out.println("criteria '"+keyword+"' generated '"+results.size()+"' results: "+results);
      return results;
   }
   ...
   public Collection<CD> getCdCatalog() {
        return c_catalog;
   }
}
